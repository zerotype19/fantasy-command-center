...
export default function LoadMyTeam() {
  ...
  const [activeTab, setActiveTab] = useState<'espn' | 'manual'>('manual');
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <p className="text-gray-600 mt-1">
          Load your team from ESPN or build it manually
        </p>
      </div>
          ...
          {activeTab === 'manual' ? (
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h2 className="text-lg font-medium text-gray-900 mb-4">ESPN League Integration</h2>
